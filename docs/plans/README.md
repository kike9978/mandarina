...
|---|---|---|
| [Phase 1 — Foundation & Learning Journey](./phase-1-foundation-and-learning-journey.md) | PWA shell, playful journey UX, session bridges, invisible FSRS, **stash/import**, **tutor pack** (brief out, JSON back) | On-device: Dexie, ts-fsrs, orchestrator, offline PWA, local dictionary. No in-app model calls |
